...
class AsyncOpenaiRequester(Base):
    ...
    def _resolve_base_url(self, platform_config: dict) -> str:
    ...
    async def request_openai_async(
        ...
        try:
            ...
            resolved_base_url = self._resolve_base_url(platform_config)
            ...
            if use_sdk:
                ...
                return await self._do_request_sdk_async(sdk_config, request_body, request_timeout)
            else:
                # ===== 原生 HTTPX 模式 =====
